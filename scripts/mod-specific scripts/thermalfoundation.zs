...
mods.tconstruct.Casting.addBasinRecipe(HardenedBase * 8, InsulatingGlass, ObsidianLiquid, 288, true);
mods.botania.ElvenTrade.addRecipe([HardenedBase * 8], [SoulGlass,Obsidian]);
