...
mods.factorytech.CompressionChamber.addRecipe(<xreliquary:mob_ingredient:12>, <minecraft:dye:0> * 5, <liquid:water_black> * 5000);
mods.factorytech.CompressionChamber.addRecipe(<xreliquary:mob_ingredient:3>, <minecraft:blaze_powder>, <fluid:sulfur> * 666);
mods.factorytech.CompressionChamber.addRecipe(<xreliquary:mob_ingredient:11>, <fluid:ender> * 2000);
...
mods.pneumaticcraft.pressurechamber.addRecipe([<tconstruct:edible:33>, <minecraft:rotten_flesh> * 8], 2.0, [<xreliquary:mob_ingredient:6> * 4]);
mods.pneumaticcraft.pressurechamber.addRecipe([<botania:blazeblock>, <tconstruct:edible:34> * 4], 2.0, [<xreliquary:mob_ingredient:7> * 4]);
mods.pneumaticcraft.pressurechamber.addRecipe([<xreliquary:mob_ingredient:6>, <minecraft:ender_pearl> * 8], 2.0, [<xreliquary:mob_ingredient:11>]);
mods.pneumaticcraft.pressurechamber.addRecipe([<minecraft:dye:0> * 10], 2.0, [<xreliquary:mob_ingredient:12>]);
...
mods.tconstruct.Casting.addTableRecipe(<xreliquary:mob_ingredient:10>, <minecraft:snowball>, <fluid:ice>, 1000, true, 60);
	// Slime drop:
mods.tconstruct.Casting.addTableRecipe(<xreliquary:mob_ingredient:4>, <minecraft:snowball>, <fluid:glass>, 1000, true, 60);
	// Squid beak:
mods.tconstruct.Casting.addTableRecipe(<xreliquary:mob_ingredient:12>, <minecraft:dye:0>, <fluid:black_water>, 10000, true, 60);
...
mods.forestry.Carpenter.addRecipe(<xreliquary:mob_ingredient:7> * 4, [[<tconstruct:edible:34> * 4, <botania:blazeblock>]], 30, <liquid:lava> * 1000);
