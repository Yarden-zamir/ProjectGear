...
mods.immersiveengineering.BottlingMachine.addRecipe(<quark:crystal> * 4, <appliedenergistics2:material:10>, <liquid:water_white> * 1000);
mods.immersiveengineering.BottlingMachine.addRecipe(<quark:crystal:1> * 4, <appliedenergistics2:material:10>, <liquid:water_red> * 1000);
mods.immersiveengineering.BottlingMachine.addRecipe(<quark:crystal:2> * 4, <appliedenergistics2:material:10>, <liquid:water_orange> * 1000);
mods.immersiveengineering.BottlingMachine.addRecipe(<quark:crystal:3> * 4, <appliedenergistics2:material:10>, <liquid:water_yellow> * 1000);
mods.immersiveengineering.BottlingMachine.addRecipe(<quark:crystal:4> * 4, <appliedenergistics2:material:10>, <liquid:water_lime> * 1000);
mods.immersiveengineering.BottlingMachine.addRecipe(<quark:crystal:5> * 4, <appliedenergistics2:material:10>, <liquid:water_light_blue> * 1000);
mods.immersiveengineering.BottlingMachine.addRecipe(<quark:crystal:6> * 4, <appliedenergistics2:material:10>, <liquid:water_blue> * 1000);
mods.immersiveengineering.BottlingMachine.addRecipe(<quark:crystal:7> * 4, <appliedenergistics2:material:10>, <liquid:water_magenta> * 1000);
