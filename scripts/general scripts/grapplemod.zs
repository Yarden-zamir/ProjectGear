...
recipes.addShapeless(<grapplemod:grapplinghook>, 
                    [<thermalfoundation:material:656>, <minecraft:lead>]);
                    // Altering recipe for grappling hook, iron pickaxe replaced by drill head
					
recipes.remove(<grapplemod:hookshot>);
recipes.addShapeless(<grapplemod:hookshot>, 
...
recipes.addShapeless(<grapplemod:multihook>, 
...
recipes.addShapeless(<grapplemod:magnetbow>, 
                    [<grapplemod:grapplinghook>, <grapplemod:repeller>]);
                    // Make recipe shapeless     
					
recipes.remove(<grapplemod:repeller>);
recipes.addShapeless(<grapplemod:repeller>, 
                    [<thermalinnovation:magnet:0>, <ore:gemCrystalFlux>]);
...
recipes.addShapeless(<grapplemod:longfallboots>, 
                    [<minecraft:diamond_boots>, <minecraft:wool>]);
                    // Make shapeless
                    
print("Completed graplemod.zs");