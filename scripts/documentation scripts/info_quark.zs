...
val batch = {
  ...
  <quark:iron_ladder> : "They work like normal ladders, except that they can stand by themselves as long as the top-most iron ladder is connected to a block. They work sort of like vines.",
  <quark:candle> : "Dyable light sources that fall like sand. ",
  <quark:iron_rod> : "Pushing it into a block with a piston will break that block. It doesn't work with slime blocks, and only works with blocks that could be pushed with a piston. Blocks like obsidian can't be broken, and the 12 block push limit still applies.",
  <quark:obsidian_pressure_plate> : "Only triggers when a player walks over it.",
  <quark:rain_detector> : "Puts out a full redstone signal if it's raining or snowing. Right click to invert.",
  <quark:arrow_ender> : "A ender pearl that can be shot with a bow.",
  <quark:arrow_explosive> : "Creates a small explosion on impact. Add a dispenser for a cheap quarry.",
  <quark:arrow_torch> : "Tries to place a torch on impact. If it can't, it drops the arrow so you can reuse it.",
  <quark:slime_bucket> : "Made by right clicking on a slime. If you're standing in a slime chunk, the slime inside bounces. It can also be used as a slime ball (you monster).",
  ...
  <quark:ancient_tome> : "Lets you get an enchanted book one level higher than is normally possible by combining it with an enchanted book of the same type. For example, combining a tome and an enchanted book with unbreaking 3 gives you unbreaking 4. Making it requires 35 levels, and applying it requires 35 more.",
  ...
  <quark:pirate_hat> : "Dropped by pirates.",
